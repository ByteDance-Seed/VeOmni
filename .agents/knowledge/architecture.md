...
Single-sample Ulysses padding stays inside the DiT forward. DiT attention follows
`attn_implementation` for single-sample and packed forwards. Packed batches return
