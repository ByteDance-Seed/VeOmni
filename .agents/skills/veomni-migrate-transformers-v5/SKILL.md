...
`transformers==5.8.1` and ships patchgen-generated modeling for every
...
Patchgen runs against `transformers==5.8.1`. Before touching code:
...
If not `5.8.1`, re-sync the default env:
