...
The test suite includes:
    ...
    End-to-end distributed tests (require ``torchrun`` with 2 processes):
        - ``test_dynamic_batching_dataset_distributed`` – parametrised over
          dataset type, shuffle, save_by_idx, checkpoint-buffer format, multi-sample
          transforms, and the DistributedDataloader ``infinity`` / ``infinity_padding``
          modes, verifying that resumed batches are byte-for-byte identical to the original run.
"""
...
@pytest.mark.parametrize(
    "dataset_type,shuffle,save_by_idx,multi_sample_per_iteration,infinity,infinity_padding",
    [
        ("iterable", False, False, False, False, False),
        ("iterable", False, True, False, False, False),
        ("iterable", True, False, False, False, False),
        ("iterable", True, True, False, False, False),
        ("iterable", True, True, True, False, False),
        ("iterable", False, False, False, True, False),
        ("iterable", True, False, False, False, True),
        ("mapping", True, True, True, False, False),
        ("mapping", True, False, False, False, False),
        ("mapping", False, False, False, True, False),
        ("mapping", True, False, False, False, True),
    ],
)
