...
def test_group_ranks_match_init_sequence_parallel_layout():
    ...
    assert ulysses_global_ranks_for_cp_rank(dp_index=0, cp_rank=0, cp_size=cp_size, ulysses_size=ulysses_size) == [
        0,
        1,
        2,
        3,
    ]
    assert ulysses_global_ranks_for_cp_rank(dp_index=0, cp_rank=1, cp_size=cp_size, ulysses_size=ulysses_size) == [
        4,
        5,
        6,
        7,
