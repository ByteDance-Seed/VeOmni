...
from tests.seed_omni.bagel.transformers.vendor.modeling.siglip.configuration_siglip import (
    SiglipVisionConfig as _SiglipVisionConfig,
)
from tests.seed_omni.bagel.transformers.vendor.modeling.siglip.modeling_siglip import (
    SiglipAttention,
