# Copied from official BAGEL implementation: https://github.com/ByteDance-Seed/Bagel/blob/main/inferencer.py
# ruff: noqa
...
from tests.seed_omni.bagel.transformers.vendor.data.data_utils import pil_img2rgb
