...
from tests.seed_omni.bagel.evals.compare_gradient_module import compare_gradient_module
...
pytestmark = pytest.mark.skipif(
    ...
    reason=f"Set {_env_name('ENABLE_PARITY_CHECK')}=1 to run BAGEL official module training parity checks.",
)
