...
_NPU_PER_MODEL_OVERRIDES: Dict[str, Dict[str, str]] = {
    ...
    "deepseek_v4": {
        ...
        # The rotary pin is mandatory rather than a preference: device_patch.py
        # disables the npu rotary backend, since the generic NPU kernel does not
        # implement V4's trailing-slice interleaved partial rotary.
