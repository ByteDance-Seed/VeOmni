...
def test_qwen3_omni_moe_registry_wires_kernel_and_upstream_talker_entries():
    ...
    from veomni.models import MODEL_PROCESSOR_REGISTRY
    from veomni.models.transformers.qwen3_omni_moe import (
...
def _stub_qwen3_omni_moe_processor():
    from veomni.models.transformers.qwen3_omni_moe.processing_qwen3_omni_moe import (
...
def test_qwen3_omni_moe_config_forces_untied_embeddings():
    from veomni.models.transformers.qwen3_omni_moe.configuration_qwen3_omni_moe import (
        Qwen3OmniMoeConfig,
    )
