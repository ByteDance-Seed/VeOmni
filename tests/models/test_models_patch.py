...
# patchgen (currently qwen2_5_omni) are *not* covered here; they keep their
# v4-style modeling code in-tree but no longer have an fwd/bwd parity test.
# Migrate them to v5 to bring them back into this list.
TEST_CASES = [
    pytest.param(
