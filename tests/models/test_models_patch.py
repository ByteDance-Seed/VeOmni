...
from veomni.arguments import CheckpointArguments, DataArguments, ModelArguments, TrainingArguments
...
class TrainerTest(BaseTrainer):
    ...
    def forward_backward_step(self, state_dict: Dict[str, torch.Tensor], model_mode: ModelMode, dataloader):
        ...
        self.args.model.network.attn_implementation = model_mode.attn_implementation
        self.args.model.network.moe_implementation = model_mode.moe_implementation
...
def test_models_patch_fwd_bwd(
    ...
    training_config = TrainingArguments(
        checkpoint=CheckpointArguments(output_dir="./test_models_patch"),
