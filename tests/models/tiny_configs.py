...
"""Canonical tiny configs shared by models registry and parity tests."""
...
def tiny_qwen2_5_omni_config(
    ...
    from veomni.models.transformers.qwen2_5_omni.configuration_qwen2_5_omni import Qwen2_5OmniConfig
