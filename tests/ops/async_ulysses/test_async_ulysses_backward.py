...
"""Numerical coverage for async Ulysses linear, LayerNorm, and repeated-KV backward units."""
...
_qkv = inspect.getmodule(VeomniOp("async_ulysses_qkv", "standard").entry.backward)
_o = inspect.getmodule(VeomniOp("async_ulysses_o", "standard").entry.backward)
