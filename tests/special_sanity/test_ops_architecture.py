...
"""Architecture guards for op-backed code, tests, and documentation."""
...
def test_model_entry_points_forward_ops_selection():
    """Require production model builders to receive the configured ops selection."""
    missing: list[str] = []
    miswired: list[str] = []
    ...
    assert not missing, "Model builders missing ops_implementation:\n" + "\n".join(missing)
