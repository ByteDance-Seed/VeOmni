...
"""Qwen3-VL models_kernel consume tests.
...
def _qwen3_vl_cls():
    ...
    if IS_NPU_AVAILABLE:
        from veomni.models_kernel.transformers.qwen3_vl.generated.patched_modeling_qwen3_vl_npu import (
...
def _build_ours(config: Qwen3VLConfig, kernels: SimpleNamespace | None = None):
...
def test_qwen3_vl_modeling_has_no_opslot_or_ops_import():
    from veomni.models_kernel.transformers.qwen3_vl.generated import patched_modeling_qwen3_vl_gpu as gpu
    from veomni.models_kernel.transformers.qwen3_vl.generated import patched_modeling_qwen3_vl_npu as npu
