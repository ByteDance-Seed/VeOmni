...
"""Qwen2.5-VL models_kernel consume tests.
...
def _build_ours(config: Qwen2_5_VLConfig, kernels: SimpleNamespace | None = None):
    from veomni.models_kernel.transformers.qwen2_5vl.generated.patched_modeling_qwen2_5_vl_gpu import (
...
def test_qwen2_5_vl_modeling_has_no_opslot_or_ops_import():
    from veomni.models_kernel.transformers.qwen2_5vl.generated import (
        patched_modeling_qwen2_5_vl_gpu as gpu,
    )
