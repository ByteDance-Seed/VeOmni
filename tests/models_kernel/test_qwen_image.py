...
"""Qwen-Image models_kernel registry, condition, and Diffusers parity tests."""
...
from tests.models_kernel.tiny_configs import tiny_qwen_image_condition_config as _tiny_condition_config
from tests.models_kernel.tiny_configs import tiny_qwen_image_config as _tiny_config
...
def _build_ours(config: QwenImageTransformer2DModelConfig):
    from veomni.models_kernel.diffusers.qwen_image.qwen_image_transformer.modeling_qwen_image_transformer import (
...
def test_qwen_image_condition_builds_from_registered_class_without_assets(monkeypatch):
    ...
    from veomni.models_kernel.diffusers.qwen_image.qwen_image_condition import modeling_qwen_image_condition
