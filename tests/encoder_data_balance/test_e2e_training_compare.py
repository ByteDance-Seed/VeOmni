...
bash train.sh tests/encoder_data_balance/test_e2e_training_compare.py configs/multimodal/qwen3_vl/qwen3_vl_moe.yaml \
...
if __name__ == '__main__':
    ...
    args.model.encoder_data_balance = False
    loss_list_wo_balance, grad_norm_list_wo_balance = train_model(copy.deepcopy(args))
    args.model.encoder_data_balance = True
    loss_list_balance, grad_norm_list_balance = train_model(copy.deepcopy(args))

    if torch.distributed.get_rank() == 0:
        print("\n=========================================")
        print("loss wo balance: ", loss_list_wo_balance)
        print("loss w. balance: ", loss_list_balance)

        print("=========================================")

        print("grad wo balance: ", grad_norm_list_wo_balance)
        print("grad w. balance: ", grad_norm_list_balance)

        torch.testing.assert_close(loss_list_balance, loss_list_wo_balance)
        torch.testing.assert_close(grad_norm_list_balance, grad_norm_list_wo_balance)
