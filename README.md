...
| Omni Model (SeedOmni V2)                                 | Any Modality Training         | [base.yaml](configs/seed_omni/Janus/janus_1.3b/train/base.yaml); [training guide](docs/seed_omni/seed_omni_v2.md) |
