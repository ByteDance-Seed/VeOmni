...
| [Qwen-Image-2.1](https://huggingface.co/Qwen/Qwen-Image-2.1) | 7B                         | [qwen_image21_lora.yaml](configs/dit/qwen_image21_lora.yaml); [training guide](docs/examples/qwen-image-2.1.md) |
