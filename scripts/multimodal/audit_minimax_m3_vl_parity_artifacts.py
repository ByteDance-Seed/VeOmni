...
REQUIRED_TOY_CHECKS = {
    ...
    "grad.lm_head.weight",
    "optimizer_delta.model.language_model.embed_tokens.weight",
    "optimizer_delta.model.language_model.layers.0.self_attn.q_proj.weight",
    "optimizer_delta.model.language_model.layers.0.self_attn.k_proj.weight",
    "optimizer_delta.model.language_model.layers.0.self_attn.v_proj.weight",
    "optimizer_delta.model.language_model.layers.0.self_attn.o_proj.weight",
    "optimizer_delta.model.language_model.layers.0.mlp.gate.weight",
    "optimizer_delta.model.language_model.layers.0.mlp.experts.gate_up_proj",
    "optimizer_delta.model.language_model.layers.0.mlp.experts.down_proj",
    "optimizer_delta.model.multi_modal_projector.linear_1.weight",
    "optimizer_delta.model.multi_modal_projector.linear_2.weight",
