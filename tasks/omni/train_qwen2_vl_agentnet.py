...
def process_sample(
    ...
    **kwargs,
    ...
    for traj in sample["traj"][-WINDOW:]:
        image = traj['image']
        images.append(Image.open("data/AgentNet/ubuntu_images/images/" + image).convert("RGB"))
    ...
    loss_mask[-1] = 1
    tokenized_example = chat_template.encode_messages(conversations, token_num_inputs, loss_mask=loss_mask)
