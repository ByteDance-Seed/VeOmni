...
EXP_NAME=vl_trainer_qwen3_vl_moe_IMPLE${moe_imple}_EP${EP_SIZE}_SP${SP_SIZE}_rmpad${USE_RM_PAD}_bs${BS}

bash train.sh tasks/train_vlm_rl.py configs/multimodal/qwen3_vl/qwen3_vl_moe.yaml \
