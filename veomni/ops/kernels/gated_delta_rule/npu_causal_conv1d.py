...
The vendored NPU kernel (`._vendor.causal_conv1d`) has a different signature
...
def causal_conv1d(
    ...
    **_ignored,
    ...
    from ._vendor.causal_conv1d import causal_conv1d as _vendor_causal_conv1d

    # weight arrives as [D, W] (conv1d.weight.squeeze(1)); the kernel wants [W, D].
    return _vendor_causal_conv1d(
        x=x,
