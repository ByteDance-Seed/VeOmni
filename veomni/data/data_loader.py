...
def build_native_dataloader(
    ...
    Args:
        ...
        infinity: In worker-side dynamic batching, restart the upstream dataset
            iterator after exhaustion and continue batching. The existing buffer is
        ...
        infinity_padding: In worker-side dynamic batching, keep yielding copies of
            ...
            downstream loss accounting. Ignored when ``infinity=True``.
    """
