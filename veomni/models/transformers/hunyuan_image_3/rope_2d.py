...
"""HunyuanImage 3 generalized 2D RoPE (model-local).

The 2D frequency layout is a bit-for-bit reproduction of Tencent's
``build_2d_rope`` at revision ``6e9113a692a27a0751d82aba3b2015a876646c03``, which
is why it lives here rather than alongside the generic RoPE primitives. Consumes
the ``[B, 2, T]`` coordinates the packed compiler emits (see
:mod:`.sequence_layout`).
"""
