...
# under the License.
"""
Patch configuration for Qwen3 GPU VeomniOp replacements.

Regen command:
patchgen veomni.models.transformers.qwen3.qwen3_gpu_patch_gen_config -o veomni/models/transformers/qwen3/generated --diff
...
config = PatchConfig(
    ...
    description="Qwen3 with VeomniOp-based GPU kernel replacements",
)
