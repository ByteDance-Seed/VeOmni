...
# ================================================================
@config.modify_init("Qwen2_5_VLVisionAttention", description="Bind instance-local rope and attention VeomniOps")
def qwen2_5_vl_vision_attention_bind_ops(original_init, self, *args, **kwargs):
