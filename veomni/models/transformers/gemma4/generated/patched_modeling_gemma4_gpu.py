...
# ==============================================================================
#
#  Source: transformers.models.gemma4.modeling_gemma4
...
#
#  Patches applied:
#    - function_replacement: create_masks_for_vision_model
#      Compose Gemma 4 bidirectional vision masks with packed-sequence boundaries
#    - method_override: Gemma4Model.__init__
#      Construct generated Gemma 4 towers directly so language-model patches are retained
#    - method_override: Gemma4Model.forward
#      Build packed-sequence-aware masks for Gemma 4 text batches
#    - method_override: Gemma4TextModel.forward
#      Pass packed-sequence boundaries into VeOmni causal and sliding-window masks
#    - method_override: Gemma4TextModel.get_per_layer_inputs
#      Preserve Gemma 4 PLE lookup while keeping generated code lint-clean
#    - method_override: Gemma4ForCausalLM.forward
#      Adapt Gemma 4 text causal-LM loss to VeOmni's fused-loss output contract
#    - method_override: Gemma4ForConditionalGeneration.forward
#      Adapt Gemma 4 multimodal causal-LM loss to VeOmni's fused-loss output contract
#
# ==============================================================================
...
# ======================================================================
# [HELPERS AFTER] Gemma4CausalLMOutputWithPast
# ======================================================================
...
# ======================================================================
# [MODIFIED CLASS] Gemma4TextModel
# Methods patched: forward, get_per_layer_inputs
# ======================================================================
...
# ======================================================================
# [MODIFIED CLASS] Gemma4ForCausalLM
...
# ======================================================================
# [PATCHED FUNCTION] create_masks_for_vision_model
# Reason: Compose Gemma 4 bidirectional vision masks with packed-sequence boundaries
# Source: veomni.models.transformers.gemma4.gemma4_gpu_patch_gen_config
# ======================================================================
...
# ======================================================================
# [MODIFIED CLASS] Gemma4ForConditionalGeneration
# Methods patched: forward
# ======================================================================
