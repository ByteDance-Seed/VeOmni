...
#  Generated: 2026-03-06T11:30:48.061624
#
...
#    - class_replacement: Qwen3_5MoeMLP
...
#      Use merged gate_up_proj layout with VeOmni fused MoE path
...
#      Support varlen flash linear attention in Qwen3_5MoeGatedDeltaNet.forward
...
#      Support SP in Qwen3_5MoeTextModel.forward
#    - method_override: Qwen3_5MoeForConditionalGeneration.__init__
#      Propagate _moe_implementation to text_config so Experts pick it up
...
from liger_kernel.transformers.swiglu import LigerSwiGLUMLP as Qwen3_5MoeMLP


# ======================================================================
# [PATCHED CLASS] Qwen3_5MoeExperts
# Original class replaced with: PatchedQwen3_5MoeExperts
# Reason: Use merged gate_up_proj layout with VeOmni fused MoE path
# Source: veomni.models.transformers.qwen3_5_moe.qwen3_5_moe_gpu_patch_gen_config
# ======================================================================
class Qwen3_5MoeExperts(torch.nn.Module):
...
from liger_kernel.transformers.rms_norm import LigerRMSNorm as Qwen3_5MoeRMSNorm
