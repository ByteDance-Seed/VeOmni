...
#      OpSlot guard for NPU fused RMSNorm (Gemma 1.0+weight formulation)
#    - function_replacement: apply_rotary_pos_emb
#      OpSlot guard for NPU fused RoPE
#    - method_override: Gemma3Model.__init__
#      Construct the generated text tower instead of the upstream AutoModel class
...
#    - method_override: Gemma3ForConditionalGeneration.__init__
#      Map legacy Gemma 3 VLM checkpoint names to the current nested model layout
#    - method_override: Gemma3ForConditionalGeneration.forward
#      Use VeOmni fused cross-entropy in the VLM forward path
#    - method_override: Gemma3ForConditionalGeneration.get_position_id_func
#      Expose standard one-dimensional position IDs to the VeOmni VLM data pipeline
#    - method_override: Gemma3ForConditionalGeneration.get_extra_collate_infos
#      Declare Gemma 3 image and token-type packing rules
#
# ==============================================================================
...
# ======================================================================
# [HELPERS AFTER] Gemma3CausalLMOutputWithPast
# ======================================================================
...
# ======================================================================
# [MODIFIED CLASS] Gemma3ForConditionalGeneration
# Methods patched: __init__, forward, get_position_id_func, get_extra_collate_infos
# ======================================================================
