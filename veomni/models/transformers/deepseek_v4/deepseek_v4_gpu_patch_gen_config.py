...
# An unbound slot reads "eager" rather than this field's own "none". That costs
# nothing here because every QAT gate below tests for the positive value
# "fp8_blockwise", so any other string -- "none", "eager", an unbound slot --
# means the same thing: no fake quantization.
