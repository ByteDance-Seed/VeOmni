...
from veomni.distributed.sequence_parallel import gather_heads_scatter_seq, gather_outputs, gather_seq_scatter_heads, reduce_sequence_parallel_loss
from veomni.distributed.context_parallel import all_gather_compressed_rows, all_gather_kv, empty_compressed_rows, exchange_compressor_halos, local_window_token_indices, plan_compressor_shard
from veomni.models.transformers.deepseek_v4.packed_utils import CompressedCandidates, build_packed_compression_metadata, build_packed_sparse_attention_indices, build_sparse_attention_indices, compress_packed_windows, isolate_packed_causal_mask_, mask_sparse_attention_indices, packed_compressed_block_bias, packed_compressed_causal_ranges, scatter_topk_block_bias, shard_packed_compression_metadata
from veomni.utils.model_outputs import FusedLinearAuxOutput, FusedLinearAuxOutputMixin, MoeCausalLMOutputWithLogProbs, MoeModelOutputWithIndexerKL
from veomni.utils.moe_router_replay import get_active_replay, maybe_replay_indices
from veomni.ops.qat import fp4_fake_quant_weight, fp8_fake_quant_act, fp8_fake_quant_act_prefix, fp8_fake_quant_stacked_weight, qat_linear
...
class DeepseekV4Indexer(nn.Module):
    ...
    def forward(
        ...
        if indexer_implementation == "npu" and not use_npu:
            raise ValueError(
                "dsa_indexer_implementation='npu' was requested outside the fused Lightning Indexer "
                "contract (training/prefill, canonical unpacked positions, no SP/CP)"
            )
        if use_npu:
...
def eager_attention_forward(
    ...
    **kwargs,
    ...
    if attention_implementation == "npu" and not use_npu:
        raise ValueError(
