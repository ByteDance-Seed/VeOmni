# Source: https://github.com/ByteDance-Seed/SeedVR/blob/e4de8c24441a67e1b7df56abea10645059bb1185/models/dit_v2/patch/patch_v1.py
...
from veomni.models.diffusers.seedvr2.core.runtime import gather_outputs, slice_inputs
...
class NaPatchIn(PatchIn):
    def forward(
        ...
        cache = (Cache(disable=True) if cache is None else cache).namespace("patch")
