# Source: https://github.com/ByteDance-Seed/SeedVR/blob/e4de8c24441a67e1b7df56abea10645059bb1185/models/video_vae_v3/modules/context_parallel_lib.py
...
from veomni.models.diffusers.seedvr2.core.vae.types import MemoryState
    ...
    if cache_size != 0 and sp_group is not None:
        ...
        if sp_rank < sp_size - 1:
            if cache_size > tensor[-1].size(2) and len(tensor) == 1:
                ...
                recv_buffer = None
            assert cache_size <= tensor[-1].size(2), (
