# Source: https://github.com/ByteDance-Seed/SeedVR/blob/e4de8c24441a67e1b7df56abea10645059bb1185/models/video_vae_v3/modules/attn_video_vae.py
# Adapted for VeOmni; original Apache-2.0 notices retained below.
...
from veomni.models.diffusers.seedvr2.core.runtime import get_sequence_parallel_world_size
from veomni.models.diffusers.seedvr2.core.utils import safe_interpolate_operation, safe_pad_operation
from veomni.models.diffusers.seedvr2.core.vae.causal_inflation_lib import (
    InflatedCausalConv3d,
    causal_norm_wrapper,
    init_causal_conv3d,
    remove_head,
)
from veomni.models.diffusers.seedvr2.core.vae.context_parallel_lib import (
    causal_conv_gather_outputs,
    causal_conv_slice_inputs,
)
from veomni.models.diffusers.seedvr2.core.vae.global_config import set_norm_limit
from veomni.models.diffusers.seedvr2.core.vae.types import (
    ...
    def __init__(
        ...
        for i, down_block_type in enumerate(down_block_types):
            ...
            self.conv_extra_cond.append(
                zero_module(nn.Conv3d(extra_cond_dim, output_channel, kernel_size=1, stride=1, padding=0))
