...
@OMNI_ACCELERATED_MODEL_REGISTRY.register("janus_llama")
def register_janus_llama_accelerated_model():
    from .accelerated import JanusLlamaAccelerated

    return JanusLlamaAccelerated
