"""Qwen3-VL text-encoder packed training hooks (wte + causal CE)."""
    ...
    def pack_decode_pre(
        ...
        **kwargs: Any,
        ...
        if packed_hidden is None or packed_labels is None:
            raise ValueError("Qwen3-VL text encoder pack_decode: packed_hidden and packed_labels are required.")
