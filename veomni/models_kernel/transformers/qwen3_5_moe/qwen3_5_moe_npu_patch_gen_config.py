...
from veomni.models_kernel.transformers.qwen3_5.qwen3_5_npu_patch_gen_config import (
...
from veomni.models_kernel.transformers.qwen3_5_moe.qwen3_5_moe_gpu_patch_gen_config import (
