...
"""
Patch configuration for Qwen3-VL VeomniKernel replacements.
...
config = PatchConfig(
    ...
    description="Qwen3-VL with VeOmni v5 patches and VeomniKernel replacements",
)
...
# ── Rotary Positional Embedding (always call rope full VeomniKernel) ─────────
