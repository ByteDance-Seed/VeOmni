...
def _caption_with_ltx_trainer(
    ...
    from veomni.models_kernel.diffusers.ltx2_3.ltx_condition.captioning import CaptionerType, create_captioner
...
def compute_video_latents(
    ...
    *overwrite* is True; writes are atomic so interrupted runs are safe to resume.
    """
    from veomni.models_kernel.diffusers.ltx2_3.ltx_core.model.video_vae import load_video_encoder
