...
class ParallelState:
    ...
    # "disabled" selects the generic Ring/Hybrid attention path for
    # non-GDN models. Qwen3.5 GDN requires one of the explicit lossless
    # implementations below; its model binding rejects "disabled".
    gdn_context_parallel_implementation: Literal["disabled", "state_passing_lossless", "kcp"] = "disabled"
