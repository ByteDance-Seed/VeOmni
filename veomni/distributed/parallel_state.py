...
def init_parallel_state(
    ...
    logger.info_rank0(
        f"Initializing parallel state... dp_size {dp_size}, dp_replicate_size {dp_replicate_size}, dp_shard_size {dp_shard_size}, tp_size {tp_size}, ep_size {ep_size}, pp_size {pp_size}, cp_size {cp_size}, ulysses_size {ulysses_size}"
    )
