...
class ParallelState:
    ...
    extra_parallel_names: List[str] = (None,)  # e.g. ["ep", "emb"]
    extra_parallel_sizes: Dict[str, int] = (None,)  # e.g. {"ep": 1, "emb": 1}
    extra_parallel_fsdp_device_mesh: Dict[str, Optional["DeviceMesh"]] = (None,)  # e.g.  {"ep": None, "emb": None}
...
def init_parallel_state(
    ...
    include_sp_in_fsdp: bool = True,
    extra_parallel_sizes: List[int] = [1],
    extra_parallel_placement_innermost: List[bool] = [1],
    extra_parallel_names: List[str] = ["ep"],
    async_enabled: Optional[bool] = False,
) -> None:
    """
