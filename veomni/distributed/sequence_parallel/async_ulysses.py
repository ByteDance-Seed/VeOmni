...
"""Thin facades for dense async Ulysses. Math lives in ``veomni.kernels``."""
...
def async_ulysses_qkv_projection(
    ...
    """Call the registered ``async_ulysses_qkv`` / ``standard`` wrapper."""
    return VeomniKernel("async_ulysses_qkv", "standard")(
        hidden_states,
        q_weight,
        q_bias,
        k_weight,
...
def async_ulysses_output_projection(
    ...
    """Call the registered ``async_ulysses_o`` / ``standard`` wrapper."""
    return VeomniKernel("async_ulysses_o", "standard")(
        hidden_states,
        proj_weight,
        proj_bias,
        seq_dimension=seq_dimension,
