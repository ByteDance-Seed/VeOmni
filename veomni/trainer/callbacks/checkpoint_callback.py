...
from ...checkpoint import ckpt_to_state_dict
...
class CheckpointerCallback(Callback):
    ...
    def _load_checkpoint(self):
        ...
        self.trainer.global_step = state["extra_state"]["global_step"]
        self.trainer.start_epoch = self.trainer.global_step // args.train.train_steps
        self.trainer.start_step = self.trainer.global_step % args.train.train_steps
        ...
        self.trainer.environ_meter.load_state_dict(state["extra_state"]["metrics_processor"])
    ...
    def _save_checkpoint(self, state: TrainerState):
        ...
        self.trainer.checkpointer.save(save_checkpoint_path, ckpt_state, global_steps=state.global_step)
