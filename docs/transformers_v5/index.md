...
`transformers==5.8.1` (the only supported transformers version).
...
- [Patchgen workflow](patchgen.md): explains the modeling code generation workflow used for every supported model and how to regenerate.
