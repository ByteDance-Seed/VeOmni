...
- [Testing a new model](testing_new_model.md): SOP for adding test cases in `test_models_patch.py` and the per-modality `test_e2e_parallel_*.py` files when onboarding a new v5 model.
