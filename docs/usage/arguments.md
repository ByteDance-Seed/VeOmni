...
enabled or disabled; when enabled, it must use the non-reentrant implementation. Model-specific numerical coverage
currently includes Qwen3-VL and dense Qwen3.5. Sequence parallelism,
