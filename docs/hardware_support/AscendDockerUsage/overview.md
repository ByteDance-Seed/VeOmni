...
| `torch_npu` | `2.10.0.post4` | torch-npu version |
...
> Note: Tags are mutable. Release builds use the published release tag; main and
> manual builds reuse the latest `v*` release tag and overwrite the image of the same name.

### Image List

| Chip Series | Architecture | Tag Example | Dockerfile |
|---|---|---|---|
| 910B (A2) | amd64 + arm64 | `v0.1.11-cann9.1.0-torch_npu2.10.0.post4-910b-ubuntu22.04-py3.12-veomni` | [x86](https://github.com/ByteDance-Seed/VeOmni/blob/main/docker/ascend/Dockerfile.ascend_9.1.0_torch_npu2.10.0.post4_910b.x86) / [arm](https://github.com/ByteDance-Seed/VeOmni/blob/main/docker/ascend/Dockerfile.ascend_9.1.0_torch_npu2.10.0.post4_910b.arm) |
| A3 | arm64 | `v0.1.11-cann9.1.0-torch_npu2.10.0.post4-a3-ubuntu22.04-py3.12-veomni` | [a3](https://github.com/ByteDance-Seed/VeOmni/blob/main/docker/ascend/Dockerfile.ascend_9.1.0_torch_npu2.10.0.post4_a3) |
...
```bash
# 910B (A2), multi-arch
docker pull quay.io/ascend/veomni:v0.1.11-cann9.1.0-torch_npu2.10.0.post4-910b-ubuntu22.04-py3.12-veomni

# A3
docker pull quay.io/ascend/veomni:v0.1.11-cann9.1.0-torch_npu2.10.0.post4-a3-ubuntu22.04-py3.12-veomni
```
...
docker run --runtime=runc -it \
  ...
  quay.io/ascend/veomni:v0.1.11-cann9.1.0-torch_npu2.10.0.post4-910b-ubuntu22.04-py3.12-veomni \
  /bin/bash
```
...
```dockerfile
FROM quay.io/ascend/veomni:v0.1.11-cann9.1.0-torch_npu2.10.0.post4-910b-ubuntu22.04-py3.12-veomni
