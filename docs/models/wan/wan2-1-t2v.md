<span id="wan2-1-t2v-training-guide"></span>
...
The configuration retains its historical I2V filename; the commands
...
| --- | --- | --- |
| Wan2.1-T2V-1.3B | [Wan-AI/Wan2.1-T2V-1.3B-Diffusers](https://huggingface.co/Wan-AI/Wan2.1-T2V-1.3B-Diffusers) | Override both model paths in the historical I2V-named config |
...
| --- | --- | --- | --- | --- |
| [wan2.1_I2V_1.3B_lora.yaml](../../../configs/dit/wan2.1_I2V_1.3B_lora.yaml) | recipe-specific | — | 1 / default | 8 |
