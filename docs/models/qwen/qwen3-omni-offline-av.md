<span id="qwen3-omni-training-with-offline-extracted-audio-enabled-video"></span>

# Qwen3 Omni: offline audio/video
...
| --- | --- | --- |
| Qwen3-Omni-30B-A3B-Instruct | [Qwen/Qwen3-Omni-30B-A3B-Instruct](https://huggingface.co/Qwen/Qwen3-Omni-30B-A3B-Instruct) | Offline audio/video input for the thinker |
...
| --- | --- | --- | --- | --- |
| [qwen3_omni_offline_av.yaml](../../../configs/multimodal/qwen3_omni/qwen3_omni_offline_av.yaml) | conversation | 8196 | 1 / default | 32 |
