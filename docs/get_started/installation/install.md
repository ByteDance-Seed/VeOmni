...
In this section, we provide the installation guide for Nvidia GPU. For other hardware platforms, please refer to the corresponding section for [Ascend NPU](installation-install_ascend).
